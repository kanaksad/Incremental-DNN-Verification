...
class TestRandomizedSmoothing(TestCase):
    def test_cifar10_rs(self):
        args = SmoothingArgs(net=config.CIFAR_RESNET_110, dataset=Dataset.CIFAR10, count=5, alpha=0.1, batch=100, sigma=0.25, N0=1000, N=100000)
        SmoothingAnalyzer(args).certify()

    def test_imagenet_rs(self):
